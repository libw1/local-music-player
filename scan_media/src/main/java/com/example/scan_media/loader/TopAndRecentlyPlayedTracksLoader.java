...
//                subscriber.onNext(SongLoader.getSongs(makeRecentTracksCursorAndClearUpDatabase(context)));
...
//            @Override
//            public void call(Subscriber<? super ArrayList<Song>> subscriber) {
//                subscriber.onNext(SongLoader.getSongs(makeTopTracksCursorAndClearUpDatabase(context)));
//                subscriber.onCompleted();
//            }
//        });
    }
