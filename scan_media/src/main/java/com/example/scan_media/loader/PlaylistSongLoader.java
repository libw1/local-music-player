...
public class PlaylistSongLoader {
    ...
    @NonNull
    public static Observable<ArrayList<PlaylistSong>> getPlaylistSongList(@NonNull final Context context, final int playlistId) {
        return Observable.create(new Observable.OnSubscribe<ArrayList<PlaylistSong>>() {
            @Override
            public void call(Subscriber<? super ArrayList<PlaylistSong>> subscriber) {
